  ...
  return (
    <section className="py-12 md:py-24">
      <div className="container mb-16 max-w-screen-md text-center">
        <h1 className="mb-6 text-5xl font-medium md:text-6xl font-serif">
          Terms of Use
        </h1>
      </div>
      <div className="container flex justify-center">
        <div className="prose prose-headings:font-serif">
          ...
          <p>
            Welcome to FamDigest ("Company", "we", "our", "us")! As you have
          ...
          <p>
            ...
            of our web pages located at https://www.famdigest.com operated by
            FamDigest
          </p>
          <p>
            ...
            https://www.famdigest.com/privacy.
          </p>
          <p>
          ...
          <p>
            ...
            support@famdigest.com so we can try to find a solution. These Terms
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Purchases</h2>
          <p>
          ...
          <p>
            ...
            cancel it or FamDigest cancels it. You may cancel your Subscription
            renewal either through your online account management page or by
            contacting FamDigest customer support team.
          </p>
          <p>
            ...
            FamDigest with accurate and complete billing information including
            ...
            you automatically authorize FamDigest to charge all Subscription
            fees incurred through your account to any such payment instruments.
          </p>
          <p>
            Should automatic billing fail to occur for any reason, FamDigest
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Free Trial</h2>
          <p>
            FamDigest may, at its sole discretion, offer a Subscription with a
          ...
          <p>
            ...
            Trial, you will not be charged by FamDigest until Free Trial has
          ...
          <p>
            At any time and without notice, FamDigest reserves the right to (i)
          ...
          <p>
            FamDigest, in its sole discretion and at any time, may modify
          ...
          <p>
            FamDigest will provide you with a reasonable prior notice of any
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Refunds</h2>
          <p>
            Except when required by law, paid Subscription fees are
            non-refundable.
          </p>
          <h2 className="text-3xl text-gray-900 dark:text-white">Content</h2>
          <p>
          ...
          <p>
            FamDigest has the right but not the obligation to monitor and edit
            all Content provided by users. In addition, Content found on or
            through this Service are the property of FamDigest or used with
          ...
          <h2 className="text-3xl text-gray-900 dark:text-white">Accounts</h2>
          <p>
          ...
          <p>
            ...
            property of FamDigest and its licensors. Service is protected by
            copyright, trademark, and other laws of foreign countries. Our
            trademarks and trade dress may not be used in connection with any
            product or service without the prior written consent of FamDigest.
          </p>
          <h2 className="text-3xl text-gray-900 dark:text-white">
            Copyright Policy
          </h2>
          ...
          <p>
            ...
            email to dmca@famdigest.com, with the subject line: "Copyright
          ...
          <p>
            You can contact our Copyright Agent via email at dmca@famdigest.com
          </p>
          <h2 className="text-3xl text-gray-900 dark:text-white">
            Error Reporting &amp; Feedback
          </h2>
          <p>
            You may provide us either directly at support@famdigest.com or via
          ...
          <p>
            ...
            that are not owned or controlled by FamDigest.
          </p>
          <p>
            FamDigest has no control over, and assumes no responsibility for the
          ...
          <p>
            YOU ACKNOWLEDGE AND AGREE THAT CALENDSO LTD SHALL NOT BE RESPONSIBLE
          ...
          <p>By email: support@famdigest.com.</p>
        </div>
      </div>
    </section>
  );
