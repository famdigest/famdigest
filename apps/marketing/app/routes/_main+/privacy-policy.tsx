  ...
  return (
    <section className="py-12 md:py-24">
      <div className="container mb-16 max-w-screen-md text-center">
        <h1 className="mb-6 font-serif text-5xl font-medium md:text-6xl">
          Privacy Policy
        </h1>
      </div>
      <div className="container max-w-screen-lg flex justify-center">
        <div className="prose prose-headings:font-serif">
          ...
          <h2>Introduction</h2>
          <p>Welcome to FamDigest.com.</p>
          <p>
            FamDigest.com ("us", "we", or "our") operates
            https://www.famdigest.com (hereinafter referred to as "Service").
          </p>
          <p>
            Our Privacy Policy governs your visit to https://www.famdigest.com,
          ...
          <h2>Definitions</h2>
          <p>
            SERVICE means the https://www.famdigest.com website operated by
            FamDigest.
          </p>
          <p>
          ...
          <p>
            ...
            emailing at hello@famdigest.com.
          </p>
          <p>
          ...
          <h2>Use of Data</h2>
          <p>FamDigest uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            FamDigest will take all the steps reasonably necessary to ensure
          ...
          <p>By email: hello@famdigest.com</p>
          <p>
          ...
          <p>
            ...
            don't use it to track you individually or collect personal user
            information. We use Google Analytics to collect information about
            how our website performs and how our users, in general, navigate
            through and use FamDigest. This helps us evaluate our users use of
            FamDigest, compile statistical reports on activity, and improve our
          ...
          <p>
            ...
            of FamDigest. We do not link this information to any of your
          ...
          <h2>E-Mails and SMS</h2>
          <h4>Twilio</h4>
          <p>
            By using FamDigest, you may receive email and SMS notifications.
            These emails and SMS are sent using our service provider Twilio. You
            agree that we may share your mobile phone number and the contents of
            any message you send or receive through such Service with our
            third-party partner, Twilio. For more information regarding how
            Twilio may store or use your information, please review Twilio's
